macro(CheckFileDialogBackend)
  ...
  if ("${BACKEND}" STREQUAL "win32")
    ...
    set(FILEDIALOG_BACKEND_SOURCES "${CMAKE_SOURCE_DIR}/src/filedialog/SDLU_filedialog_win32.c")
  endif()

  if ("${BACKEND}" STREQUAL "cocoa")
    add_definitions("-DFILEDIALOG_COCOA")
    set(LIBS ${LIBS} -Wl,-framework,Cocoa -lobjc)
    set(FILEDIALOG_BACKEND_SOURCES "${CMAKE_SOURCE_DIR}/src/filedialog/SDLU_filedialog_cocoa.m")
  endif()
  ...
  if ("${BACKEND}" STREQUAL "gtk")
    ...
    set(FILEDIALOG_BACKEND_SOURCES "${CMAKE_SOURCE_DIR}/src/filedialog/SDLU_filedialog_gtk.c")
  endif()
